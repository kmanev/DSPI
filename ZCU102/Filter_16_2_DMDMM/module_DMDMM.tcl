...
source ./static_placement_constraints_border_East_DMDMM.tcl
source ./static_placement_constraints_border_West_DMDMM.tcl
source ./static_placement_constraints_partial_module_DMDMM.tcl
source ./static_interface_constraints_border_East_DMDMM.tcl
source ./static_interface_constraints_border_West_DMDMM.tcl

source ./place_flops_West_DMDMM.tcl
source ./place_flops_East_DMDMM.tcl

source ./Filter_Pblock_DMDMM.tcl
...
#top border 124
puts "#top border"
ted::routing::blockFreeNodes [ted::routing::getNetVCC] [get_nodes -of_objects [get_tiles -filter {TYPE==INT_RBRK && GRID_POINT_Y==124 && GRID_POINT_X>129 && GRID_POINT_X<149}] -filter {!IS_VCC && !IS_GND && NAME!~*/LIOB_MONITOR* && NAME!~*CLK* && NAME!~*BUFCE*}]
...
#left border
puts "#left border"
source ./blocker_West_DMDMM.tcl
#right border
puts "#right border"
source ./blocker_East_DMDMM.tcl
