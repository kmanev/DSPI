...
proc create_root_design { parentCell } {
  ...
  # Create instance: BlockerTest_0, and set properties
  set block_name BlockerTest
  set block_cell_name BlockerTest_0
  if { [catch {set BlockerTest_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $BlockerTest_0 eq "" } {
  ...
  connect_bd_net -net BlockerTest_0_EtoWbusOut [get_bd_pins BlockerTest_0/EtoWbusOut] [get_bd_pins WestCon_0/EtoWbusOut]
  connect_bd_net -net BlockerTest_0_WtoEbusOut [get_bd_pins BlockerTest_0/WtoEbusOut] [get_bd_pins EastCon_0/WtoEbusOut]
  connect_bd_net -net EastCon_0_EtoWbusIn [get_bd_pins BlockerTest_0/EtoWbusIn] [get_bd_pins EastCon_0/EtoWbusIn]
  connect_bd_net -net WestCon_0_WtoEbusIn [get_bd_pins BlockerTest_0/WtoEbusIn] [get_bd_pins WestCon_0/WtoEbusIn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins BlockerTest_0/clk] [get_bd_pins EastCon_0/clk] [get_bd_pins WestCon_0/clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
