...
# module references:
# BlockerTestSuccessful, EastCon, WestCon
...
proc create_root_design { parentCell } {
  ...
  # Create instance: BlockerTestSuccessful_0, and set properties
  set block_name BlockerTestSuccessful
  set block_cell_name BlockerTestSuccessful_0
  if { [catch {set BlockerTestSuccessful_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $BlockerTestSuccessful_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: EastCon_0, and set properties
  set block_name EastCon
  set block_cell_name EastCon_0
  if { [catch {set EastCon_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $EastCon_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: WestCon_0, and set properties
  set block_name WestCon
  set block_cell_name WestCon_0
  if { [catch {set WestCon_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $WestCon_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net BlockerTestSuccessful_0_EtoWbusOut [get_bd_pins BlockerTestSuccessful_0/EtoWbusOut] [get_bd_pins WestCon_0/EtoWbusOut]
  connect_bd_net -net BlockerTestSuccessful_0_WtoEbusOut [get_bd_pins BlockerTestSuccessful_0/WtoEbusOut] [get_bd_pins EastCon_0/WtoEbusOut]
  connect_bd_net -net EastCon_0_EtoWbusIn [get_bd_pins BlockerTestSuccessful_0/EtoWbusIn] [get_bd_pins EastCon_0/EtoWbusIn]
  connect_bd_net -net WestCon_0_WtoEbusIn [get_bd_pins BlockerTestSuccessful_0/WtoEbusIn] [get_bd_pins WestCon_0/WtoEbusIn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins BlockerTestSuccessful_0/clk] [get_bd_pins EastCon_0/clk] [get_bd_pins WestCon_0/clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
